...
The _Polymorphism Library_ is _multi-variant_. What does that mean?
...
The _Polymorphism Library_ uses these namespaces:

* `GanbaroDigital\Polymorphism\V1` - version 1.x of the library
* `GanbaroDigital\Polymorphism\V2` - reserved for version 2.x of the library
